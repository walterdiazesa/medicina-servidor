...
<body>
    ...
    <div style="border-radius: 8px; background-color: #fff; padding: 16px; text-align: center; max-width: 384px; margin-left: auto; margin-right: auto; padding-bottom: 20px;">
      ...
      <h1 style="font-weight: 600; color: #374151; margin: 0;">¡&quot;<span style="color: #14b8a6;">${
        test.lab.name
      }</span>&quot; te ha invitado a su laboratorio!</h1>
    ...
    test.id
  }" style="border-radius: 6px; background-color: #14b8a6; color: #fff; font-weight: 600; padding-left: 16px; padding-right: 16px; padding-top: 8px; padding-bottom: 10px; text-decoration: none;">Aceptar invitación</a>
    </div>
  </div>
</body>
</html>`;
